...
- [`Schanuel/ConjugationStableSectorBoundary.lean`](./Schanuel/ConjugationStableSectorBoundary.lean)
  ...
  genuine terminal exponential equation, so adjoining the mixed invariant removes exactly the
  two non-analytic sheets.  The resulting quadratic analytic terminal witness, while retaining
  the complete quartic sign action, is incorporated into the strongest final disjoint
  equivalence with failure of the conjecture.
