...
The registered root list contains forty-six modules. The full build succeeds with 2924 jobs.
...
and genuine eigenvector-complement exports have the same audit result.  Each checked export uses only
